...
class DashboardController extends Controller
{
    ...
    {
        // NOTE: SalesOrder now reads from Sales Order Management's real
        // sales_orders table (previously a local duplicate — see that
        // model's docblock). Closed Deals will reflect whatever SOM has
        // actually seeded for this date range; Total Revenue instead sums
        // rep_targets, which was seeded with realistic quarter totals.
